...
void main () {
    ...
    printf("Fifth Quiz Grade:");
    scanf("%f", &quiz5);
    printf("The value entered is %f.\n",quiz5);

    printf("Sixth Quiz Grade:");
    scanf("%f", &quiz6);
    printf("The value entered is %f.\n",quiz6);
    

    quizsum = quiz1 + quiz2 + quiz3 + quiz4 + quiz5 + quiz6;
    quizAverage = quizsum / 6;
    quizweightedAverage = quizAverage *.10;
    ...
    projectAverage = projectsum;
    projectweightedAverage = projectAverage * .10;
